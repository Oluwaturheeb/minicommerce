                                    ...
                                    <li class="minicart-wrap">
                                        <a href="#miniCart" class="minicart-btn toolbar-btn">
                                            ...
                                            <div class="minicart-front_text">
                                                <span>Cart:</span>
                                                <span class="total-price">2345678</span>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="sp-img_area">
                                ...
                                "asNavFor": ".sp-img_slider-nav"
                                    ...
                                    <div class="single-slide red zoom">
                                        <img src="{{ $item->picture }}" alt="Uren's Product Image">
                                    </div>
                            ...
                            <div class="sp-content">
                                ...
                                <div class="sp-essential_stuff">
                                    <ul>
                                        ...
                                        <li>Product Code: <a href="javascript:void(0)">Product {{ $item->slug }}</a></li>
                                        ...
                                        <li>Price 
                                            <a href="javascript:void(0)">
                                                ...
                                                <b>₦{{ number_format($amount, 2) }} </b><del>₦{{ number_format($item->amount) }}</del>
                                                @else
                                                {{ $item->amount }}
                                                @endif
                                            </a>
                                ...
                                <form method="post" action="{{ route('add-to-cart') }}">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" value="1" type="number" name="quantity" max="{{ $item->quantity }}">
                                    ...
                                    <div class="qty-btn_area">
                                        ...
                                        <ul>
                                            <li><a class="qty-cart_btn"><button>Add To Cart</button></a></li>
