            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="inner-slide">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="single-product/{{ $item->slug }}">
                                                    <img class="primary-img" src="{{ $item->picture }}" alt="Uren's Product Image">
                                                    <img class="secondary-img" src="{{ $item->picture }}" alt="Uren's Product Image">
                                                </a>
                                                <div class="sticker">
                                                ...
                                                <div class="add-actions">
                                                    <ul>
                                                        <li><a class="uren-add_cart" href="cart" data-toggle="tooltip" data-placement="top" title="Add To Cart" data-item-id="{{ $item->id }}"><i
                                                            class="ion-bag"></i></a>
                                                        </li>
                                            ...
                                            <div class="product-content">
                                                <div class="product-desc_info">
                                                    ...
                                                    <h6><a class="product-name" href="single-product/{{ $item->slug }}">{{ $item->item_name }}</a></h6>
                                                    <div class="price-box">
                                                        <span class="new-price">
                                                            @if ($item->discount)
                                                            <?php $amount = $item->amount - ($item->discount / 100) * $item->amount; ?>
                                                            ₦{{ number_format($amount, 2) }} <del>₦{{ number_format($item->amount) }}</del>
                                                            @else
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                ...
                                                <h6><a class="product-name" href="single-product.html">{{$item->item_name}}</a></h6>
                                                <div class="price-box">
                                                    <span class="new-price">
                                                        @if ($item->discount)
                                                        {{ number_format($item->amount * ($item->discount / 100)) }} <del>{{ number_format($item->amount) }}</del>
                                                        @else
                                                        {{ $item->amount }}
                                                        @endif
                                                    </span>
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="uren-add_cart" href="cart" data-toggle="tooltip" data-placement="top" title="Add To Cart" data-item-id="{{ $item->id }}><i class="ion-bag"></i></a>
                                                    </li>
                                                    <li><a class="uren-wishlist" href="wishlist.html" data-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i
                                                        class="ion-android-favorite-outline"></i></a>
                                                    </li>
                        ...
                        {{ $items->data->links('vendor.pagination.custom') }}
                    </div>
                </div>
            </div>
        </div>
