                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="table-content table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="uren-product-remove"><a href="/cart/delete/{{ $item->item_id }}"><i class="fa fa-trash"
                                                title="Remove"></i></a></td>
                                            <td class="uren-product-thumbnail"><a href="javascript:void(0)"><img src="{{ $item->item->picture }}" width="200" alt="Uren's Cart Thumbnail"></a></td>
                                            <td class="uren-product-name"><a href="single-product/{{ $item->item->slug }}">{{ $item->item->item_name }}</a></td>
                                            <td d class="uren-product-price"><span class="amount">
                                               @if ($item->item->discount)
                                               <?php $amount = $item->item->amount - ($item->item->discount / 100) * $item->item->amount; ?>
                                                ₦{{ number_format($amount, 2) }}<br> <del>₦{{ number_format($item->item->amount, 2) }}</del>
                                                @else
                                                ₦{{ number_format($item->item->amount) }}
                                                @endif
                                            </span></td>
                                            <td class="quantity">
                                            ...
                                            <td class="product-subtotal"><span class="amount">
                                                @if ($item->item->discount)
                                                ₦{{ number_format($amount * $item->quantity, 2) }}<br> <del>₦{{ number_format($item->item->amount * $item->quantity, 2) }}</del>
                                                @else
                                                ₦{{ number_format($item->item->amount * $item->quantity, 2) }}
                                                @endif</span></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-5 ml-auto">
                                    <div class="cart-page-total">
                                        <h2>Cart totals</h2>
                                        <ul>
                                            <li>Total <span>₦{{ number_format($cart['cartTotal'], 2) }}</span></li>
                                        </ul>
                        ...
                        <div class="col-md-6 mx-auto">
                            <div class="cart-page-total justify-items-center text-center">
                                <h2>Nothing in your cart yet!</h2>
                                <a href="{{ route('index') }}">Shop now!</a>
                            </div>
                        </div>
                        @endif
                    </div>
