                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-4">
                            <div class="ht-right_area">
                                <div class="ht-menu">
                                    <ul>
                                        <li><a href="javascript:void(0)">Currency<i
                                            ...
                                            <ul class="cat-mega-menu cat-mega-menu-2">
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-left-sidebar.html">Cordless Nail Guns</a>
                                                        </li>
                                                        <li><a href="shop-left-sidebar.html">Electric Nail Guns</a>
                                                        </li>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-left-sidebar.html">Reciprocating Saws</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                    ...
                                    @foreach ($address as $addr)
                                        <div class="col-md-12">
                                            <div class="checkout-form-list create-acc">
                                                <input id="{{ $addr->country }}" type="radio"
                                                    value="{{ $addr->id }}" name="address">
                                                <label
                                                    for="{{ $addr->country }}">{{ $addr->street . ', ' . $addr->city . ', ' . $addr->state . ', ' . $addr->country }}</label>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($cartItems as $item)
                                                <tr class="cart_item">
                                                    <td class="cart-product-name"> {{ $item->item->item_name }}<strong
                                                            class="product-quantity">
                                                            × {{ $item->quantity }}</strong>
                                                    </td>
                                                    <td class="cart-product-total"><span class="amount">
                                                            @if ($item->item->discount)
                                                                ₦{{ number_format(($item->item->amount * ($item->item->discount / 100) * $item->quantity), 2) }}
                                                            @else
                                                                ₦{{ number_format($item->item->amount, 2) }}
                                                            @endif
                                                        </span>
                                                    </td>
                                        ...
                                        <tfoot>
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span
                                                            class="amount">₦{{ number_format($cart['cartTotal'], 2) }}</span></strong>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <div class="payment-method">
                                    <div class="payment-accordion">
                                        ...
                                        <div class="order-button-payment">
                                            <input value="Place order" type="button" id="payNow">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
-->
    ...
    <script>
        const payWithPaystack = () => {
            var handler = PaystackPop.setup({
                ...
                callback: function(response) {
                    var form = $('#checkout-form').serializeArray().map(function(x) {
                        this[x.name] = x.value;
                        return this;
                    }.bind({}))[0];
                    ...
                    if (response.status == 'success') {
                        $.ajax({
                            ...
                            error: () => $('button#payNow').prop('disabled', false),
                        });
                    } else {
        ...
        $('#payNow').click(function(e) {
            ...
            } else alert('Kindly select a delivery address!');
        });
    </script>
